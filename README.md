...
## Imágenes en Vercel
Las imágenes públicas están en `public/images/` y se referencian desde HTML con rutas absolutas `/images/...`.
Vite copia automáticamente `public/images` a `dist/images` durante `npm run build`, lo que evita errores 404 de imágenes en Vercel.
